...
public class SecondActivity extends AppCompatActivity{
    ...
    ImageView c1View, c2View, c3View, c4View, c5View, c6View, c7View, c8View, c9View, c10View,
        ...
        c51View, c52View,
    ////////////////////////////////////////////////////////////////////////////////////////////////
        c1BackView, c2BackView, c3BackView, c4BackView, c5BackView, c6BackView,
    ...
    void showMessageBoard() {
        ...
        messBoardCardViewAnim.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                ...
                // Wait before starting the animation crownDeal()
                try {
                    Thread.sleep(5000);
                   // crownDeal();
...
////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            mainPlayerDealAnim.setAnimationListener(new Animation.AnimationListener() {
                ...
                public void onAnimationEnd(Animation animation) {
                    ...
                    if (random.nextInt(deckBackViews.size()) != c13BackView || c26BackView ||c39BackView || c52BackView) {
            ...
            randCardBackView.setImageResource(random.nextInt(deckBackViews.size())); // redundant bc every Image on deckBackViews is the same.
